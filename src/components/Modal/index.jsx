          ...
          <Container>
            ...
            <PageBookInfo>
              ...
              <PageBookBody>
                ...
                <div>
                  <strong>Publicação</strong> <span>{book?.published}</span>
                </div>
                <div>
                  <strong>Idioma</strong> <span>{book?.language}</span>
                </div>
                <div>
                  <strong>Título Original</strong> <span>{book?.title}</span>
                </div>
                <div>
                  <strong>ISBN-10</strong> <span>{book?.isbn10}</span>
                </div>
                <div>
                  <strong>ISBN-13</strong> <span>{book?.isbn13}</span>
                </div>
              </PageBookBody>
              <PageBookFooter>
